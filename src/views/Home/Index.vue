<template>
  <dv-full-screen-container>
    <el-container id="home">
      <el-aside :style="'width: '+screenWidth*0.15+'px;z-index:10'" id="aside">
        <el-menu :default-active="$route.path" @open="handleOpen" @close="handleClose" background-color="#112d4e"
          text-color="#eeeeee" active-text-color="#3f72af" router class="menuNav">
          >
          <el-menu-item @click="sys_info">
            <div v-if="this.$root.sys_status === 1">
              <div style="color:green">
                <i class="el-icon-cpu"></i>
                <span slot="title">服务器在线</span>
              </div>
            </div>
            <div v-if="this.$root.sys_status === -1">
              <div style="color:red">
                <i class="el-icon-cpu"></i>
                <span slot="title">OJ离线</span>
              </div>
            </div>
            <div v-if="this.$root.sys_status === 0">
              <div style="color:red">
                <i class="el-icon-cpu"></i>
                <span slot="title">服务器离线</span>
              </div>
            </div>
          </el-menu-item>
          ...
          <el-menu-item index="/home/nav5">
            <i class="el-icon-potato-strips"></i>
            <span slot="title">站内排名</span>
          </el-menu-item>
        </el-menu>
      </el-aside>
      <el-container>
        <el-header id="header">
          ...
          <el-row>
            ...
            <el-col :span="6">
              ...
              <a href="/"><img src="../../../public/sologon.png" style="width:80%;margin-left:25%" alt=""></a>
                ...
                <el-button type="text">
                  <span>
                    <div v-if="user_profile === null">
                      <i class="el-icon-user-solid">&nbsp;<span style="color:black">账户管理</span></i>
                    </div>
                    <div v-else style="display:flex">
                      ...
                      <div v-else style="paddingTop:6px">&nbsp;<span style="color:black">账户管理</span>&nbsp;<span
            ...
            <!-- 教师入口 -->
            <el-col :span="2">
              <div v-if="user_profile!==null && user_profile.user.admin_type==='Admin'" style="marginTop:-3px">
                <el-button type="text" @click="gotoTeacherSide"><span style="color:black">教师入口</span></el-button>
              </div>
              <div v-else-if="user_profile!==null && user_profile.user.admin_type==='Super Admin'"
                style="marginTop:-8px">
                <el-button type="text" @click="gotoAdminSide"><span style="color:black">管理入口</span></el-button>
              </div>
            </el-col>
            <!-- 系统通知 -->
    ...
    <!-- 联系我们抽屉 -->
    <el-drawer title="联系我们" :visible.sync="dialog" append-to-body direction="ltr" size="50%" custom-class="demo-drawer"
      ref="drawer">
      <el-popover style="position:absolute;right:100px;top:10px" placement="right-end" title="联系我们？" width="200"
        ...
        <el-button slot="reference"><span style="color:green;margin-left:10%"><i class=" el-icon-question"></i></span>
        </el-button>
      </el-popover>
        ...
        <div v-if="sysinfo_annoucement==='sysinfo' && user_profile!==null">
          <div v-for="(info, index) of sysinfo_arr" :key="index" style="margin:10px;">
            <dv-border-box-8 :dur=6 style="height:100px"><br>&nbsp;&nbsp;{{info.msg}}
              <el-col :span="20">
                <dv-border-box-13>
                  <el-button style="float: right; padding: 3px 0" type="primary" @click="set_info_read(info.id)">已读
                  </el-button>
                </dv-border-box-13>
...
<script type="text/javascript" src="https://sf1-scmcdn-tos.pstatp.com/goofy/ee/lark/h5jssdk/lark/js_sdk/h5-js-sdk-1.5.2.js">
window.h5sdk.ready(() => {
